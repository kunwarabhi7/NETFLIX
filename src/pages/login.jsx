    ...
    <div className='fixed w-full px-4 py-24 z=50'>
      <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
        <div className='max-w-[320px] mx-auto py-16'>
         ...
         <div className='mt-12 flex text-gray-600'><p>New to Netflix? </p>
         <Link to='signup'>
         <p className='text-white ml-3'>Sign up now.</p>
         </Link>
         </div>
         <div className=' mt-12 flex flex-col ' ><p>This page is protected by Google reCAPTCHA to ensure you're not a bot.</p><p className='text-blue-600'> Learn more.</p></div>
           </form>
        </div>
